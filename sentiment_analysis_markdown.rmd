...
It is unlikely that I would be lucky enough to have perfectly balanced samples in reality. To make the analysis more realistic, I imbalanced the samples and then re-balanced them through random re-sampling.
...
Next, I trained each of my four models:
